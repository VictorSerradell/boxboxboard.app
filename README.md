...
**Live:** [boxboxboard.app](https://boxboxboard.app) · **Stack:** Next.js 14, TypeScript, Tailwind CSS
...
```bash
# 1. Clone
git clone https://github.com/VictorSerradell/boxboxboard
cd boxboxboard .app
...
- **Subject:** OAuth2 Client Request — BoxBoxBoard
- **Client Name:** BoxBoxBoard
- **Client Type:** Server-side (Authorization Code)
- **Redirect URIs:** `https://boxboxboard.app/api/auth/callback/iracing`
...
```
NEXT_PUBLIC_BASE_URL    = https://boxboxboard.app
IRACING_CLIENT_ID       = your_client_id
IRACING_CLIENT_SECRET   = your_client_secret
IRACING_REDIRECT_URI    = https://boxboxboard.app/api/auth/callback/iracing
...
BoxBoxBoard is not affiliated with, endorsed by, or associated with iRacing.com Motorsport Simulations. iRacing is a registered trademark of iRacing.com Motorsport Simulations.
