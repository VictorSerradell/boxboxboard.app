...
export async function GET(request: NextRequest) {
  ...
  if (!seriesId) return NextResponse.json({ cars: [], total_drivers: 0, subsessions_sampled: 0 });
  ...
  try {
    ...
    return NextResponse.json({ cars, total_drivers: totalDrivers, subsessions_sampled: topIds.length });
