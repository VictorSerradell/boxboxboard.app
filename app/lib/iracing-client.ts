  ...
  try {
    ...
    return seasons.map((s: any): SeriesSeason => {
      ...
      return {
        ...
        // Computed UI fields
        category: mapCategory(s.license_group, s.category),
...
function mapCategory(licenseGroup: number, rawCategory?: string): CarCategory {
  if (rawCategory) {
  ...
  // Fallback by license group (iRacing convention)
  // 1=Oval, 2=Road, 3=Dirt Oval, 4=Dirt Road, 5=Sports Car
